    ...
    <div className='mb-6 p-4 bg-white rounded-lg shadow-md relative dark:bg-gray-800 dark:text-gray-200'>
      ...
      <ul className='list-none'>
        {sekolah.map((item) => (
          ...
          >
            <div className='text-gray-900 font-semibold mb-2 dark:text-white'>
              <ul>
                <li>{item.nama.toUpperCase()}</li>
                <li>Kota: {item.kota}</li>
                <li>Jumlah Siswa: {item.jumlah_siswa}</li>
                <li>
                ...
                <li>
                  Konsentrasi:{' '}
                  {item.konsentrasi.length > 0 ? (
                    item.konsentrasi.length > 1 ? (
                      <ul className='list-disc ml-5'>
                        {item.konsentrasi.map((k) => (
                          <li key={k.id}>{k.nama}</li>
                        ))}
                      </ul>
                    ) : (
                      item.konsentrasi[0].nama
                    )
                  ) : (
